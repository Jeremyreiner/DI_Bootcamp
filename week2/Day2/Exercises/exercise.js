...
/*---------------------Exercise 2: Chihuahua-----------------------Instructions*/
...
/*else, console.log ‘I dont care, I prefer cats’*/
	...
	console.log("I dont really care, i prefer cats.")
...
/*if(num1 %2==0){
	console.log(num1 + "is an even numver")
}*/
	...
	case 0:
 	...
 	case 1:
  	...
  	case 2:
    	...
    	break;
  	default:
  		console.log(` ${users[0]},  ${users[1]} + ${length - 2}  are online.`);
}
